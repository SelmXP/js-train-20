...
//Truck.prototype.specific = function (cargo) {
Truck.prototype.tow = function (cargo) {
  if (cargo > this.towingCapacity)
...
Car.prototype.drive = function (kilometers) {
  this.mileage += kilometers; // <<==== НЕМАЄ поля kilometers у прототипі Car!!! результат не накопичуєтья!!!! хіба що можна додавати до пробігу (mileage) - ТАК і ЗРОБИВ
  console.log(
...
const сarDrive = car.drive.bind(car);
// Викликаємо функцію зі значенням 100,
сarDrive(100);
// console.log(car.valueOf()); // перевірив чи пробіг збільшився
/*
